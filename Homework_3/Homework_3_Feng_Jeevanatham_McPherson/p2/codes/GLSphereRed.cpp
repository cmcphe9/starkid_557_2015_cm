 ...
 */
void GLSphereRed::setModelMatrix(glm::mat4& modelmatrix)
{
 ...
 */
void GLSphereRed::enableNormalVectorRenderer(bool value )
{
 ...
 */
void GLSphereRed::initVBONormals(void)
{
...
void GLSphereRed::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
