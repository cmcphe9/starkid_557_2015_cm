 ...
 */
void GLSphereBlue::setModelMatrix(glm::mat4& modelmatrix)
{
 ...
 */
void GLSphereBlue::enableNormalVectorRenderer(bool value )
{
 ...
 */
void GLSphereBlue::initVBO(void)
{
 ...
 */
void GLSphereBlue::initVBONormals(void)
{
 ...
 */
void GLSphereBlue::initShaderNormal(void)
{
...
void GLSphereBlue::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
