 ...
 */
void GLSphereYellow::setModelMatrix(glm::mat4& modelmatrix)
{
 ...
 */
void GLSphereYellow::enableNormalVectorRenderer(bool value )
{
 ...
 */
void GLSphereYellow::initVBO(void)
{
 ...
 */
void GLSphereYellow::initVBONormals(void)
{
...
void GLSphereYellow::initShader(void)
{
    ...
    _program = LoadAndCreateShaderProgram("../data/shaders/yellowsphere.vs", "../data/shaders/yellowsphere.vs");
#else
    // This loads the shader program from a file
    _program = LoadAndCreateShaderProgram("/Users/geethanjalijeevanatham/Desktop/Helloworld/myopenGL/model/testing/assignment2/Problem2/Problem2/data/shaders/yellowsphere.vs", "/Users/geethanjalijeevanatham/Desktop/Helloworld/myopenGL/model/testing/assignment2/Problem2/Problem2/data/shaders/yellowsphere.fs");
#endif
    glUseProgram(_program);
    ...
    ///////////////////////////////////////////////////////////////////////////////////////////////
    // Material
    _material._diffuse_material = glm::vec3(0.5, 0.5, 0.1);
    _material._ambient_material = glm::vec3(0.6, 0.6, 0.1);
    ...
    _light_source2._lightPos = glm::vec4(19.5,2.1,10.5, 1.0);
    _light_source2._ambient_intensity = 0.0;
    _light_source2._specular_intensity = 0.6;
    _light_source2._diffuse_intensity = 2.0;
    _light_source2._attenuation_coeff = 0.02;
    
    _light_source2._cone_angle = 32.0; // in degree
    _light_source2._cone_direction = glm::vec3(0.0, 0.0, -1.0); // this m
    ...
    // define the position of the light and send the light position to your shader program
    _light_source1._lightPos = glm::vec4(-15.0,-7.0,12.0,0.0);
    _light_source1._ambient_intensity = 0.0;
    _light_source1._specular_intensity = 0.2;
    _light_source1._diffuse_intensity = 2.3;
 ...
 */
void GLSphereYellow::initShaderNormal(void)
{
...
void GLSphereYellow::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
