 ...
 */
void GLSphereGreen::setModelMatrix(glm::mat4& modelmatrix)
{
 ...
 */
void GLSphereGreen::enableNormalVectorRenderer(bool value )
{
 ...
 */
void GLSphereGreen::initVBO(void)
{
 ...
 */
void GLSphereGreen::initVBONormals(void)
{
 ...
 */
void GLSphereGreen::initShaderNormal(void)
{
...
void GLSphereGreen::make_Sphere(Vertex center, double r, std::vector<Vertex> &spherePoints, std::vector<Vertex> &normals)
{
