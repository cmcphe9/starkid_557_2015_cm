...
//
//  Modified by Floyd Richardson on 12/8/15
//
...
GLObjectObj* spaceship;

// The sphere object
//GLSphereInt3D* sphere_result;
GLObjectObj* spaceship_result
...
//    loadedModel1->setMatrix(tranform);
    ...
    material_spaceship._diffuse_material = glm::vec3(1.0, 0.0, 0.0);
    material_spaceship._ambient_material = glm::vec3(1.0, 0.0, 0.0);
    material_spaceship._specular_material = glm::vec3(1.0, 1.0, 1.0);
    material_spaceship._shininess = 2.0;
    ...
    // Create a spaceship
    spaceship = new GLObjectObj("../data/SciFi_Fighter_MK/SciFi_Fighter_MK-OBJ.obj");
    spaceship->setApperance(*apperance_spaceship);
    spaceship->init();
    
    // move the sphere up
    g_tranform_spaceship= glm::translate(glm::vec3(0.0, 0.0f, 10.0f));
    spaceship->setMatrix(g_tranform_spaceship);
    ...
    spaceship_result = new GLObjectObj("../data/SciFi_Fighter_MK/SciFi_Fighter_MK-OBJ.obj");
